  ...
  return (
    <figure className="relative h-[80vh] w-full">
      <img
        ...
        alt="nature image"
      />
      <figcaption className="absolute bottom-1/3  left-1/4 flex  -translate-x-1/4 justify-between rounded-xl border border-white bg-white/75 py-4 px-6 shadow-lg shadow-black/5 saturate-200 backdrop-blur">
        <div>
